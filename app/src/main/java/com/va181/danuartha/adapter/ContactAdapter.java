package com.va181.danuartha.adapter;
...
import com.va181.danuartha.InputActivity;
import com.va181.danuartha.R;
import com.va181.danuartha.TampilActivity;
import com.va181.danuartha.model.Contact;
...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.ContactViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ContactViewHolder holder, int position) {
        ...
        holder.tvNegara.setText(tempContact.getnegara());
    ...
    public class ContactViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener{
        ...
        private TextView tvName, tvNegara;
        ...
        public void onClick(View v) {
            ...
            openDisplay.putExtra("NEGARA", tvNegara.getText());
        ...
        public boolean onLongClick(View v) {
            ...
            openInput.putExtra("NEGARA", tvNegara.getText());
