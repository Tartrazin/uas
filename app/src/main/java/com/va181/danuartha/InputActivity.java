...
import com.va181.danuartha.services.ApiClient;
import com.va181.danuartha.services.ApiContact;
...
public class InputActivity extends AppCompatActivity {
    ...
    private EditText editFirstName, editLastName, editNegara, editEmail;
        ...
        switch(view.getId()) {
            case R.id.jekel_laki:
                if (checked) {
                    ...
                    imgLocation = ApiClient.IMAGE_URL + "putin.jpg";
                    break;
                }
            case R.id.jekel_perempuan:
                if (checked) {
                    gender = getString(R.string.gender_female);
                    imgLocation = ApiClient.IMAGE_URL + "han.jpeg";
                    break;
                }
        }
    }
    ...
    private void saveData() {
        ...
        String negara = editNegara.getText().toString();
        String email = editEmail.getText().toString();
        if(!(firstName.equals("") && lastName.equals("") && negara.equals(""))) {
            ApiContact api = ApiClient.getRetrofitInstance().create(ApiContact.class);
            Call<ResponseData> call;
            if(updateOperation == false) {
                call = api.addData(firstName, lastName, negara, email, imgLocation, gender);
            } else {
                call = api.editData(String.valueOf(id), firstName, lastName, negara, email, imgLocation, gender);
                updateOperation = false;
            }
            ...
            Toast.makeText(this, "Data nama dan negara harus diberikan", Toast.LENGTH_LONG).show();
        }
